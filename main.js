...
if (sessionStorage["logueado"]) {
	...
	seccionUsuario.innerHTML = `
								...
								<li class="nav-item"><a class="nav-link active" aria-current="page" href="./pages/reserva.html">Reservar</a></li>
	...
	seccionUsuario.innerHTML = `
								<li class="nav-item"><a class="nav-link active" aria-current="page" href="./pages/login.html">Iniciar sesion</a></li>
								<li class="nav-item"><a class="nav-link active" aria-current="page" href="./pages/register.html">Registrarme</a></li>
								`
}
